...
private:
	...
	const void HandleMessage(const ETileInteractionMessage Message, const ETileInteractionAction NotifyPattern, const UETileType HoveredTileType, TSet<int>& VisitedNeighbors, const UEHexNeighborDirection Direction, const ETileInteractionFeedback Feedback, const FLinearColor FeedbackColor, const int Distance);
	template<typename... Args>
	const void TransmitMessageInDirection(const ETileInteractionMessage Message, const ETileInteractionAction NotifyPattern, const UETileType HoveredTileType, TSet<int>& VisitedNeighbors, const UEHexNeighborDirection Direction, const ETileInteractionFeedback Feedback, const FLinearColor FeedbackColor, const int Distance, Args*... Neighbors);
...
protected:
	...
	virtual const void HandleMessage(const ETileInteractionMessage Message, const UETileType HoveredTileType, const ETileInteractionFeedback Feedback, const FLinearColor FeedbackColor) override;
	virtual const void NotifyNeighbors(const ETileInteractionMessage Message, const ETileInteractionAction NotifyPattern, const UETileType HoveredTileType, const int Distance, const ETileInteractionFeedback Feedback = ETileInteractionFeedback::None, const FLinearColor FeedbackColor = FLinearColor::White) override;
public:	
